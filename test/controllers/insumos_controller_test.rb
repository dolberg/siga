...
class InsumosControllerTest < ActionController::TestCase
  ...
  test "should create insumo" do
    assert_difference('Insumo.count') do
      post :create, insumo: { precfin: @insumo.precfin, precin: @insumo.precin, producto: @insumo.producto, salin: @insumo.salin, usuario_id: @insumo.usuario_id }
    end
  ...
  test "should update insumo" do
    patch :update, id: @insumo, insumo: { precfin: @insumo.precfin, precin: @insumo.precin, producto: @insumo.producto, salin: @insumo.salin, usuario_id: @insumo.usuario_id }
    assert_redirected_to insumo_path(assigns(:insumo))
  end
