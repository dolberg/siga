...
class ActividadsControllerTest < ActionController::TestCase
  ...
  test "should create actividad" do
    assert_difference('Actividad.count') do
      post :create, actividad: { actividad: @actividad.actividad, tipo: @actividad.tipo, usuario_id: @actividad.usuario_id }
    end
  ...
  test "should update actividad" do
    patch :update, id: @actividad, actividad: { actividad: @actividad.actividad, tipo: @actividad.tipo, usuario_id: @actividad.usuario_id }
    assert_redirected_to actividad_path(assigns(:actividad))
  end
